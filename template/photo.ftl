...
<body>
  <#escape x as x?html>
    <div class="container">
      ...
      <#if onlineMeetingEnableByMini && screenshots?? && (screenshots?size > 0)>
        <div class="page cloud-screenshot  page-break-before">
          <div class="title">云端截图</div>
          <div class="imgs">
            <#list screenshots as screenshot>
              <div class="img-box <#if screenshot?index !=0>page-break-before</#if> ">
                <img class="img" src="${screenshot.url}" alt="" />
