...
<head>
    ...
    <style>
        ...
        * {
        ...
        .meeting-detail th, .meeting-detail td {
            font-size: 12px;
        }
    ...
    <div class="container">
        <div class="container-all">
          ...
          <span class="public-header-tltle"><a
            ...
            <span class="public-header-tltle-right-code">
              <span class="public-header-tltle-right-code-name">会议编码</span>
              <span>${planCode}</span>
            </span>
            <#if supplement?? && supplement==true>
                ...
                <#if supplementEnable?? && supplementEnable==true>
                  ...
                  <img width="100%" height="100%" style="width: 100%; height: 100%"
                       src="https://representative-1252497236.cos.accelerate.myqcloud.com/static/schedule-management/repair-record.png"/>
                        <!-- </div> -->
                </div>
                </#if>
            </#if>
            ...
            <#if showParticipant?? && showParticipant>
            ...
            <span class="public-header-tltle"><a
              ...
              参会信息</span>
                    ...
                    <div class="attend-info-main">
                        <#if (participantCount?? && participantCount !=0) || (planCustomerCount?? && planCustomerCount !=0)>
                            <div class="attend-info-main-people">
                                ...
                                <#if planCustomerCount?? && planCustomerCount !=0>
                                    <div class="people-two">
                                        <label>计划参会客户：</label>
                                        <span>${planCustomerCount}人 ｜ 其中已参会：${alreadyAttend!''}人</span>
                                    </div>
                                </#if>
                            </div>
                        </#if>
                        <#if attendanceAddress?? && attendanceAddress!='' && showAttendance?? && showAttendance>
                        ...
                        statistics.onlineCustomerCount !=0 )>
                            <div class="attend-info-main-customer">
                                ...
                                <#if statistics.attendanceCount?? && statistics.attendanceCount !=0 && showAttendance?? && showAttendance>
                                ...
                                <#if statistics.onlineCustomerCount?? && statistics.onlineCustomerCount !=0>
                                    <div class="customer-there">
                                        <label>在线客户：</label>
                                        <span>${statistics.onlineCustomerCount}人 ｜ 客户平均在线时长：${statistics.avgDuration}</span>
                                    </div>
                                </#if>
                            </div>
                        </#if>
                        ...
                        statistics.onlineRepCount !=0 )>
                            <div class="attend-info-main-staff">
                                ...
                                <#if statistics.attendanceRepCount?? && statistics.attendanceRepCount !=0 && showAttendance?? && showAttendance>
                                    <div class="staff-two">
                                        <label>签到员工：</label>
                                ...
                                <#if statistics.onlineRepCount?? && statistics.onlineRepCount !=0>
                                    <div class="staff-there">
                                        <label>在线员工：</label>
                                        <span>${statistics.onlineRepCount}人 ｜ 员工平均在线时长：${statistics.avgDurationRep}</span>
                                    </div>
                                </#if>
                            </div>
                        </#if>
              ...
              其他信息</span>
                    ...
                    <#if planExpense?? && (planExpense.list??)>
                        ...
                        <table style="border-collapse: collapse;margin-top:30px">
                            <tr>
                                <th width="209">费用类型</th>
                                <th width="120">金额（元）</th>
                                <th>备注</th>
                            </tr>
                            <#if (planExpense.list?size> 0)>
                                <#list planExpense.list as expenseInfo>
                                    <tr>
                                        <td>
                                            ${expenseInfo.type}
                                        </td>
                    ...
                    <#if actualExpense?? && (actualExpense.list??)>
                        ...
                        <table style="border-collapse: collapse;margin-top:30px">
                            ...
                            <#if (actualExpense.list?size> 0)>
                                <#list actualExpense.list as expenseInfo>
                                    <tr>
                                        <td>
                                            ${expenseInfo.type}
                                        </td>
                        ...
                        <#if customFields ??>
                            <#list customFields as custom>
                                ...
                                <#if custom.type=='FILE'>
                                    <div class="temp-text">
                                        <div class="temp-title"
                                             style="font-size: 16px; font-weight: 500; color: #333333;">${custom.name}
                                            ：
                                        </div>
                                        <div class="temp-list">
            ...
            <#if showQuestionnaire?? && showQuestionnaire && questionnaires?? && (questionnaires?size> 0)>
                <div class="ask">
                    <div class="public-header">
            <span class="public-header-tltle"><a
                        style="pointer-events:none; color:#1ab370; font-size:30px;">・</a>
          ...
          <span class="public-header-tltle"><a
            ...
            执行标准</span>
                    ...
                    <#list 0..(executeStandards?size-1) as i>
                        <!-- 参会人数 -->
                        <#if i==0 && (executeStandards[i].executionStandardType == 'NUMBER_OF_ATTENDING_DOCTORS' || executeStandards[i].executionStandardType=='MAXIMUM_PARTICIPANTS_PER_DOCTOR_PER_DEPARTMENT')>
                                    ...
                                    <#list executeStandards as executeStandard>
                                        <#if executeStandard.executionStandardType=='NUMBER_OF_ATTENDING_DOCTORS'>
                                            <tr>
                                                ...
                                                <td>
                                                    <#if executeStandard.isSatisfied?? && executeStandard.isSatisfied>
                                        ...
                                        <#if executeStandard.executionStandardType=='MAXIMUM_PARTICIPANTS_PER_DOCTOR_PER_DEPARTMENT'>
                                            <tr>
                                                <td>单医院单科室最多参会人数</td>
                                                <td>${executeStandard.standardValue!}</td>
                                                <td>${executeStandard.actualValue!}</td>
                            ...
                            <!-- 参会频率 -->
                        <#elseif executeStandards[i].executionStandardType == 'MAXIMUM_ATTENDANCE_COUNT_FOR_DOCTOR_WITHIN30_DAYS' >
                            ...
                            <div class="speaker-main">
                                <table style="border-collapse: collapse">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <#if executeStandards[i].isSatisfied?? && executeStandards[i].isSatisfied>
                                                <span style="color: #1AB370;">达标</span>
                                            </#if>
                                            <#if executeStandards[i].isSatisfied?? && !executeStandards[i].isSatisfied>
                                                <span style="color: #FF4D4F;">未达标</span>
                        ...
                        <#elseif executeStandards[i].executionStandardType == 'MAXIMUM_ACTUAL_EXPENSES' >
                            ...
                            <!-- 讲者 -->
                        <#elseif executeStandards[i].executionStandardType == 'MAXIMUM_LECTURE_COUNT_PER_YEAR' >
