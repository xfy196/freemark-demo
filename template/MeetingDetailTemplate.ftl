                            ...
                            <table style="border-collapse: collapse">
                                <tr>
                                    ...
                                    <#if speakers.displayDeptColumn==true>
                                        <th>
                                            ${speakers.computedDeptName!''}
                                        </th>
                                    </#if>
                                    <#if speakers.displayTitleColumn==true>
                                        <th>
                                            ${speakers.computedTitleName!''}
                                        </th>
                                    </#if>
                                </tr>
                                ...
                                <div class="attend-info-main-customer">
                                    <#if statistics.uniqCustomerCount?? && statistics.uniqCustomerCount !=0>
                                        <div class="customer-one">
                                            <label>参会客户：</label>
                                            <span>
                                                ${statistics.uniqCustomerCount}人</span>
                                        </div>
                                    </#if>
                                    <#if statistics.attendanceCount?? && statistics.attendanceCount !=0>
                                        <div class="customer-two">
                                            <label>签到客户：</label>
                                            <span>
                                                ${statistics.attendanceCount}人</span>
                                        </div>
                                    </#if>
                                    <#if statistics.onlineCustomerCount?? && statistics.onlineCustomerCount !=0>
                                        <div class="customer-there">
                                            <label>在线客户：</label>
                                            <span>
                                                ${statistics.onlineCustomerCount}人 ｜
                                                客户平均在线时长：${statistics.avgDuration}
                                            </span>
                                        </div>
                                    </#if>
                                </div>
                                ...
                                <div class="attend-info-main-staff">
                                    <#if statistics.uniqRepCount?? && statistics.uniqRepCount !=0>
                                        <div class="staff-one">
                                            <label>参会员工：</label>
                                            <span>
                                                ${statistics.uniqRepCount}人</span>
                                        </div>
                                    </#if>
                                    <#if statistics.attendanceRepCount?? && statistics.attendanceRepCount !=0>
                                        <div class="staff-two">
                                            <label>签到员工：</label>
                                            <span>
                                                ${statistics.attendanceRepCount}人</span>
                                        </div>
                                    </#if>
                                    <#if statistics.onlineRepCount?? && statistics.onlineRepCount !=0>
                                        <div class="staff-there">
                                            <label>在线员工：</label>
                                            <span>
                                                ${statistics.onlineRepCount}人 ｜
                                                员工平均在线时长：${statistics.avgDurationRep}
                                            </span>
                                        </div>
                                    </#if>
                                </div>
                            ...
                            <table style="border-collapse: collapse">
                                ...
                                <#list cloudRecords as cloudRecord>
                                    <tr>
                                        ...
                                        <td>
                                            ${cloudRecord.durationStr}
                                        </td>
                                        <td>
                                            ${(cloudRecord.fileSize/1024/1024)?string("#.##")}MB</td>
                        ...
                        <div class="cloud-chart-img">
                            <#list screenshots as screenshot>
                                ...
                                <div class="picture-info">
                                    <div class="info-left">
                                        <span>截图人：${screenshot.author}
                                        </span>
                                        <span class="split-line"> </span>
                                        <span class="">截图时间：${screenshot.time}
                                        </span>
                                    </div>
                                    <div class="info-right">
                                        参会人员：${statistics.attendeePeopleCount}
                                    </div>
                                </div>
                            </#list>
                        </div>
                                                                            ...
                                                                            <div class="speaker-main">
                                                                                <table style="border-collapse: collapse">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td>医生近30天参会次数上限</td>
                                                                                        <td>
                                                                                            ${executeStandards[i].standardValue!}
                                                                                        </td>
                                                                                        <td>
                                                                                            ${executeStandards[i].actualValue!}
                                                                                        </td>
                                                                                        <td>
                                                                                                ...
                                                                                                <table style="border-collapse: collapse">
                                                                                                    ...
                                                                                                    <#list executeStandards as executeStandard>
                                                                                                        <#if executeStandard.executionStandardType=='MAXIMUM_LECTURE_COUNT_PER_YEAR'>
                                                                                                            ...
                                                                                                            <#elseif executeStandard.executionStandardType=='MAXIMUM_FEE_COUNT_PER_YEAR'>
                                                                                                                <tr>
                                                                                                                    <td>年讲课费用上限</td>
                                                                                                                    <td>
                                                                                                                        ${executeStandard.standardValue!}
